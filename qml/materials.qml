    ...
    Entity {
		...
		Entity {
				...
				effect: Effect {
					techniques: Technique {
						renderPasses: RenderPass {
							...
							parameters: [
                                Parameter {name: "viewPos"; value: root.viewPos},
                                Parameter {name: "material.ambient"; value: root.material.ambient},
                                Parameter {name: "material.diffuse"; value: root.material.diffuse},
                                Parameter {name: "material.specular"; value: root.material.specular},
                                Parameter {name: "material.shininess"; value: root.material.shininess},
                                Parameter {name: "light.position"; value: light.position},
                                Parameter {name: "light.ambient"; value: light.ambient},
                                Parameter {name: "light.diffuse"; value: light.diffuse},
                                Parameter {name: "light.specular"; value: light.specular}
							]
						}
					}
				}
			...
			PhongMaterial {
				...
				*/
				id: qtMaterial
                ambient: Qt.rgba(root.material.ambient.x, root.material.ambient.y, root.material.ambient.z, 1.)
                diffuse: Qt.rgba(root.material.diffuse.x, root.material.diffuse.y, root.material.diffuse.z, 1.)
                specular: Qt.rgba(root.material.specular.x, root.material.specular.y, root.material.specular.z, 1.)
				...
				effect: Effect {
					techniques: Technique {
						renderPasses: RenderPass {
							...
							parameters: [
                                Parameter {name: "ourColor"; value: root.lightColor}
							]
						}
					}
				}
		...
		SequentialAnimation {
            ...
            ColorAnimation {target: root; property: "lightColor"; duration: 2000; to: "green"}
            ColorAnimation {target: root; property: "lightColor"; duration: 2000; to: "grey"}
            ColorAnimation {target: root; property: "lightColor"; duration: 2000; to: "blue"}
            ColorAnimation {target: root; property: "lightColor"; duration: 2000; to: "white"}
            ColorAnimation {target: root; property: "lightColor"; duration: 2000; to: "red"}
            ColorAnimation {target: root; property: "lightColor"; duration: 2000; to: "black"}
		}
	}
}
