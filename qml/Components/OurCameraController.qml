	...
	LogicalDevice {
		...
		axes: [
			Axis {
				...
				id: xAxis
                AnalogAxisInput {sourceDevice: mouseDevice; axis: MouseDevice.X}
			},
			Axis {
				id: yAxis
                AnalogAxisInput {sourceDevice: mouseDevice; axis: MouseDevice.Y}
			},
			Axis {
				id: wAxis
                AnalogAxisInput {sourceDevice: mouseDevice; axis: MouseDevice.WheelY}
			}
		]
	}
